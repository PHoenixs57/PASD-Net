...
#ifndef PASDNET_DATA_H
#define PASDNET_DATA_H
...
#define ATTN_DENSE_OUT_SIZE 384
...
int init_pasdnet(PASDNet *model, const WeightArray *arrays);

#endif /* PASDNET_DATA_H */
